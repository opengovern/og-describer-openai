...
type CreateChatCompletionRequest struct {
	...
	Prediction NullableCreateChatCompletionRequestPrediction `json:"prediction,omitempty"`
...
func (o *CreateChatCompletionRequest) GetPrediction() CreateChatCompletionRequestPrediction {
	if o == nil || IsNil(o.Prediction.Get()) {
		var ret CreateChatCompletionRequestPrediction
		return ret
	}
...
// SetPrediction gets a reference to the given NullableCreateChatCompletionRequestPrediction and assigns it to the Prediction field.
