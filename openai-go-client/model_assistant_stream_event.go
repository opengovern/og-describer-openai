...
func (dst *AssistantStreamEvent) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonDoneEvent) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.DoneEvent); err != nil {
				dst.DoneEvent = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonErrorEvent) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ErrorEvent); err != nil {
				dst.ErrorEvent = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonMessageStreamEvent) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.MessageStreamEvent); err != nil {
				dst.MessageStreamEvent = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonRunStepStreamEvent) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.RunStepStreamEvent); err != nil {
				dst.RunStepStreamEvent = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonRunStreamEvent) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.RunStreamEvent); err != nil {
				dst.RunStreamEvent = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonThreadStreamEvent) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ThreadStreamEvent); err != nil {
				dst.ThreadStreamEvent = nil
			} else {
				match++
			}
